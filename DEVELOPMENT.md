...
```bash
git remote add encore encore://nuture-student-insurance-58d2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/nuture-student-insurance-58d2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/nuture-student-insurance-58d2/settings/integrations/github)
